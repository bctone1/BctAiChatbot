...
class Wp_BCT_Ai_Admin
{
    ...
    public function enqueue_styles()
    {
        ...
        // if (strpos($screen->id, 'bctai') !== false) {
        //     wp_enqueue_style('jquery-ui',plugin_dir_url(__DIR__) . 'src/css/jquery-ui.css',array(),$this->version,'all');
        // }
    ...
    {
        include BCTAI_PLUGIN_DIR . 'admin/views/module_manager.php';
    }
