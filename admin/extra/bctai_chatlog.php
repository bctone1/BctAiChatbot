...
<form action="" method="get">
    ...
    <!-- <div class="bctai-d-flex mb-5">
        <input value="<?php echo esc_html($search)?>" class="regular-text" name="wsearch" type="text" placeholder="Type for search">
    ...
    if($bctai_logs && is_array($bctai_logs) && count($bctai_logs)) {
        foreach( $bctai_logs as $bctai_log ) {
            ...
            <tr>
                ...
                <td>
                    <button class="btn btnXS bgPrimary bctai-log-messages" data-messages="<?php echo esc_html(htmlspecialchars(wp_json_encode($all_messages),ENT_QUOTES, 'UTF-8'))?>">View</button>
                </td>
            </tr>
