...
<div style="display: flex;">
    <div class="setting_wrap" style="width:85%;">
        ...
        <div class="OpenAI_wrap"style=" display:<?php echo $bctai_chat_provider =='OpenAI' ? 'block':'none'?>">
            ...
            <?php
                $gpt4_models = ['gpt-4o','gpt-4o-mini','gpt-4-turbo','gpt-4','gpt-4-0613','gpt-4-0314','gpt-4-32k'];
                $gpt35_models = ['gpt-3.5-turbo', 'gpt-3.5-turbo-16k','gpt-3.5-turbo-instruct','gpt-3.5-turbo-0125'];
            ...
            <button href="javascript:void(0)" class="bctai_sync_finetunes btn btnXS bgPrimary"><?php echo esc_html__('Sync Model', 'bctai') ?></button>
        ...
        <div class="columnWrap Pinecone_wrap" style=" display:<?php echo $bctai_vector_db_provider =='pinecone' ? 'block':'none'?>;">
            <div class="columnWrap column2">
