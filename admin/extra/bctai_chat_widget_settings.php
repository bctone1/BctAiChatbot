...
if ( isset( $_POST['bctai_submit'] ) ) {
    ...
    if(!$errors) {
        //구글 LLM 저장
        if (isset($_POST['wpaicg_google_model']) && !empty($_POST['wpaicg_google_model'])) {
            update_option('wpaicg_google_default_model', sanitize_text_field($_POST['wpaicg_google_model']));
        }
...
<div style="display: flex;">
    <div class="setting_wrap" style="width:85%;">
        ...
        <h3 class="chapterTitle">Provider</h3>
        <div class="columnWrap">
            <div class="columnWrap column2">
                <div class="formContent">
                    <select class="regular-text" id="bctai_chat_provider" name="bctai_chat_provider">
                        ...
                        <option <?php echo $bctai_chat_provider == 'Huggingface' ? ' selected': ''?> value="Huggingface"><?php echo __('Huggingface', 'bctai') ?></option>
        ...
        <h3 class="chapterTitle">GPT Model Settings</h3>
        ...
        <div class="OpenAI_wrap"style=" display:<?php echo $bctai_chat_provider =='OpenAI' ? 'block':'none'?>">
            

            <?php
                $gpt4_models = ['gpt-4o','gpt-4o-mini','gpt-4-turbo','gpt-4','gpt-4-0613'];
                $gpt35_models = ['gpt-3.5-turbo', 'gpt-3.5-turbo-16k','gpt-3.5-turbo-0125'];
                // $gpt3_models = ['text-babbage-001', 'text-ada-001'];
                ...
                <div class="columnWrap column2">
                    ...
                    <div class="formContent">
                        <div class="inputButtonArea">
                            <select class="regular-text" id="bctai_chat_model" name="bctai_chat_model">
                            ...
                            <button type="button" class="btn btnL bgPrimary iconLoading iconOnly on bctai_sync_finetunes" type="button"><span class="blind">새로고침</span></button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="Google_wrap" style=" display:<?php echo $bctai_chat_provider =='Google' ? 'block':'none'?>">
            <div class="columnWrap">
                <div class="columnWrap column2">
                    <div class="formTitle"><strong>Model</strong></div>
                    <div class="formContent">
                        <div class="inputButtonArea">
                            <select id="wpaicg_google_model" name="wpaicg_google_model" class="specific-select">
                                ...
                                <option value="gemini-pro" <?php selected( 'gemini-pro', $wpaicg_google_default_model );?>><?php echo esc_html__( 'Gemini Pro', 'gpt3-ai-content-generator' );?></option><?php }?>
                            </select>
                            <button type="button" id="syncGoogleButton" class="btn btnL bgPrimary iconLoading iconOnly on wpaicg_sync_google_models" type="button"><span class="blind">새로고침</span></button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="columnWrap column2">
                    ...
                    <div class="formContent">
                        ...
                        <div class="inputButtonArea">
                            ...
                            <button type="button" class="btn btnL bgPrimary iconLoading iconOnly on wpaicg_sync_openrouter_models"id="syncButton"><span class="blind">새로고침</span></button>
        ...
        <div class="columnWrap">
            <div class="columnWrap column2">
                <div class="formTitle"><strong>Temperature</strong></div>
                <div class="formContent">
                    <input type="text" class="regular-text" id="label_temperature" name="bctai_chat_temperature" value="<?php echo esc_html( $bctai_chat_temperature );?>">
                </div>
            </div>
        </div>
        ...
        <div class="columnWrap">
            <div class="columnWrap column2">
                <div class="formTitle"><strong>Max Tokens</strong></div>
                <div class="formContent">
                    <input type="text" class="regular-text" id="label_max_tokens" name="bctai_chat_max_tokens" value="<?php echo esc_html( $bctai_chat_max_tokens );?>">
                </div>
            </div>
        </div>
        <div class="columnWrap">
            <div class="columnWrap column2">
                <div class="formTitle"><strong>Top P</strong></div>
                <div class="formContent">
                    <input type="text" class="regular-text" id="label_top_p" name="bctai_chat_top_p" value="<?php echo esc_html( $bctai_chat_top_p );?>">
                </div>
            </div>
        </div>
        <!-- <div class="columnWrap">
            <div class="columnWrap column2">
                <div class="formTitle"><strong>Best Of</strong></div>
                <div class="formContent">
                    <input type="text" class="regular-text" id="label_best_of" name="bctai_chat_best_of" value="<?php echo esc_html( $bctai_chat_best_of );?>">
                </div>
            </div>
        </div> -->
        ...
        <div class="columnWrap">
            <div class="columnWrap column2">
                <div class="formTitle"><strong>Frequency Penalty</strong></div>
                <div class="formContent">
                    <input type="text" class="regular-text" id="label_frequency_penalty" name="bctai_chat_frequency_penalty" value="<?php echo esc_html( $bctai_chat_frequency_penalty );?>">
                </div>
            </div>
        </div>
        ...
        <div class="columnWrap">
            <div class="columnWrap column2">
                <div class="formTitle"><strong>Presence Penalty</strong></div>
                <div class="formContent">
                    <input type="text" class="regular-text" id="label_presence_penalty" name="bctai_chat_presence_penalty" value="<?php echo esc_html( $bctai_chat_presence_penalty );?>">
                </div>
            </div>
        </div>


        <h3 class="chapterTitle">Output message settings</h3>

        <div class="columnWrap">
            <div class="columnWrap column2">
                <div class="formTitle"><strong>AI Name</strong></div>
                <div class="formContent">
                    <input type="text" class="regular-text" name="_bctai_chatbox_ai_name" value="<?php echo esc_html( get_option( '_bctai_chatbox_ai_name', 'AI' ) );?>">
                </div>
            </div>
        </div>
        ...
        <div class="columnWrap">
            <div class="columnWrap column2">
                <div class="formTitle"><strong>You</strong></div>
                <div class="formContent">
                    <input type="text" class="regular-text" name="_bctai_chatbox_you" value="<?php echo esc_html( get_option( '_bctai_chatbox_you', 'You' ) );?>">
                </div>
            </div>
        </div>
        ...
        <div class="columnWrap">
            <div class="columnWrap column2">
                <div class="formTitle"><strong>AI Thinking</strong></div>
                <div class="formContent">
                    <input type="text" class="regular-text" name="_bctai_ai_thinking" value="<?php echo esc_html( get_option( '_bctai_ai_thinking', 'AI thinking' ) );?>">
                </div>
            </div>
        </div>
        <div class="columnWrap">
            <div class="columnWrap column2">
                <div class="formTitle"><strong>Placeholder</strong></div>
                <div class="formContent">
                    <input type="text" class="regular-text" name="_bctai_typing_placeholder" value="<?php echo esc_html( get_option( '_bctai_typing_placeholder', 'Type a message' ) );?>">
                </div>
            </div>
        </div>
        ...
        <div class="columnWrap">
            <div class="columnWrap column2">
                <div class="formTitle"><strong>Welcome Message</strong></div>
                <div class="formContent">
                    <input type="text" class="regular-text" name="_bctai_chatbox_welcome_message" value="<?php echo esc_html( get_option( '_bctai_chatbox_welcome_message', 'Hello human, I am a GPT powered AI chat.' ) );?>">
                </div>
            </div>
        </div>
        ...
        <!-- <div class="columnWrap">
            <div class="columnWrap column2">
                ...
                <div class="formContent">
                    <select name="bctai_chat_widget[remember_conversation]">
        ...
        <div class="columnWrap">
            <div class="columnWrap column2">
                <div class="formTitle"><strong>Remember Conv. Up To</strong></div>
                <div class="formContent">
        ...
        <div class="columnWrap">
            <div class="columnWrap column2">
                <div class="formTitle"><strong>User Aware</strong></div>
                <div class="formContent">
                    <select name="bctai_chat_widget[user_aware]">
        ...
        <div class="columnWrap">
            <div class="columnWrap column2">
                <div class="formTitle"><strong>Content Aware</strong></div>
                <div class="formContent">
                    <select name="bctai_chat_widget[content_aware]" id="bctai_chat_content_aware">
        ...
        <div class="columnWrap">
            <div class="columnWrap column2">
                <div class="formTitle"><strong>Use Basic</strong></div>
                <div class="formContent">
                    <input class="widget_input_radios"<?php echo !$bctai_chat_embedding && $bctai_chat_content_aware == 'yes' ? ' checked': '';?> <?php echo $bctai_chat_content_aware == 'no' ? ' disabled':'';?> type="checkbox" id="bctai_chat_excerpt" class="<?php echo $bctai_chat_embedding && $bctai_chat_content_aware == 'yes' ? 'asdisabled' : ''?>">
                </div>
            </div>
        </div>
        ...
        <div class="columnWrap">
            <div class="columnWrap column2">
                <div class="formTitle"><strong>Use Embeddings</strong></div>
                <div class="formContent">
                    <input <?php echo $bctai_chat_embedding && $bctai_chat_content_aware == 'yes' ? ' checked': ''?><?php echo $bctai_embedding_field_disabled || $bctai_chat_content_aware == 'no' ? ' disabled':''?> type="checkbox" value="1" name="bctai_chat_embedding" id="bctai_chat_embedding" class="<?php echo !$bctai_chat_embedding && $bctai_chat_content_aware == 'yes' ? 'asdisabled' : ''?>">
                </div>
            </div>
        </div>
        ...
        <h3 class="chapterTitle">Vector DB Settings</h3>

        <div class="columnWrap">
            <div class="columnWrap column2">
                <div class="formTitle"><strong>Default Vector DB</strong></div>
                <div class="formContent">
                    <select <?php echo $bctai_embedding_field_disabled || empty($bctai_chat_embedding) || $bctai_chat_content_aware == 'no' ? ' disabled':''?> id="bctai_vector_db_provider" name="bctai_vector_db_provider"class="bctai_vector_db_provider">
        ...
        <div class="Pinecone_wrap" style=" display:<?php echo $bctai_vector_db_provider =='pinecone' ? 'block':'none'?>;">
            <div class="columnWrap">
                <div class="columnWrap column2">
                    ...
                    <div class="formContent">
                        <div class="inputButtonArea">
                            <select <?php echo $bctai_embedding_field_disabled || empty($bctai_chat_embedding) || $bctai_chat_content_aware == 'no' ? ' disabled':''?> name="bctai_chat_widget[embedding_index]" id="bctai_chat_embedding_index" class="<?php echo !$bctai_chat_embedding && $bctai_chat_content_aware == 'yes' ? 'asdisabled' : ''?>">
                        ...
                        <input type="text" class="bctai_pinecone_api" name="bctai_pinecone_api" value="<?php echo esc_attr($bctai_pinecone_api) ?>" style="display:none;">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="Qdrant_wrap" style=" display:<?php echo $bctai_vector_db_provider =='qdrant' ? 'block':'none'?>">
            <div class="columnWrap">
                <div class="columnWrap column2">
                    ...
                    <div class="formContent">
                        <input <?php echo $bctai_embedding_field_disabled || empty($bctai_chat_embedding) || $bctai_chat_content_aware == 'no' ? ' disabled':''?> type="text" id="bctai_qdrant_endpoint" class="bctai_qdrant_endpoint" name="bctai_qdrant_endpoint" value="<?php echo esc_attr($bctai_qdrant_endpoint) ?>" >
                    </div>
                </div>
            </div>
            ...
            <div class="columnWrap">
                <div class="columnWrap column2">
                    ...
                    <div class="formContent">
                        <div class="inputButtonArea">
                            <select class="wpaicg_qdrant_collections_dropdown" name="wpaicg_qdrant_default_collection" id="wpaicg_qdrant_default_collection" <?php echo $bctai_embedding_field_disabled || empty($bctai_chat_embedding) || $bctai_chat_content_aware == 'no' ? ' disabled':''?>>
                                <?php
                            ...
                            <button type="button" class="btn btnL bgPrimary wpaicg_sync_qdrant_collections"><span><?php echo esc_html__('Sync Collections','gpt3-ai-content-generator')?></span></button>
                        </div>
                        <input type="text" class="bctai_qdrant_api" name="bctai_qdrant_api" value="<?php echo esc_attr($bctai_qdrant_api) ?>" style="display:none;">
                    </div>
                </div>
            </div>            
        </div>
        ...
        <div class="columnWrap">
            <div class="columnWrap column2">
                <div class="formTitle"><strong>Method</strong></div>
                <div class="formContent">
                    <select <?php echo $bctai_embedding_field_disabled || empty($bctai_chat_embedding) || $bctai_chat_content_aware == 'no' ? ' disabled':''?> name="bctai_chat_embedding_type" id="bctai_chat_embedding_type" class="<?php echo !$bctai_chat_embedding && $bctai_chat_content_aware == 'yes' ? 'asdisabled' : ''?>">
        ...
        <div class="columnWrap">
            <div class="columnWrap column2">
                <div class="formTitle"><strong>Nearest Answers Up To</strong></div>
                <div class="formContent">
                    <select <?php echo $bcti_embedding_field_disabled || empty($bctai_chat_embedding) || $bctai_chat_content_aware == 'no' ? ' disabled':''?> name="bctai_chat_embedding_top" id="bctai_chat_embedding_top" class="<?php echo !$bctai_chat_embedding && $bctai_chat_content_aware == 'yes' ? 'asdisabled' : ''?>">
        ...
        <h3 class="chapterTitle">Voice Settings</h3>

        <div class="columnWrap">
            <div class="columnWrap column2">
                <div class="formTitle"><strong>Enable Speech to Text</strong></div>
                <div class="formContent">
                    <input <?php echo $bctai_audio_enable ? ' checked':''?> value="1" class="bctai_chat_widget_audio" type="checkbox" name="bctai_chat_widget[audio_enable]">
                </div>
            </div>
        </div>
        ...
        <div class="columnWrap">
            <div class="columnWrap column2">
                <div class="formTitle"><strong>Select Method</strong></div>
                <div class="formContent">
                    <select <?php echo empty($bctai_audio_enable) ? ' disabled':''?> name="bctai_chat_widget[stt_method]">
        ...
        <div class="columnWrap">
            <div class="columnWrap column2">
                <div class="formTitle"><strong>Enable Text to Speech</strong></div>
                <div class="formContent">
                    <input <?php echo empty($bctai_google_api_key) ? ' disabled':''?><?php echo (!empty($bctai_google_api_key)) && $bctai_chat_to_speech ? ' checked':''?> value="1" type="checkbox" name="bctai_chat_widget[chat_to_speech]" class="bctai_chat_to_speech">
                </div>
            </div>
        </div>
        <p style ="display:<?php echo empty($bctai_google_api_key) ? 'block' : 'none' ?>;color:red;"><?php echo __('*Missing Google API key','bctai')?></p>

        <?php $disabled_voice_fields = false;
            if(!$bctai_chat_to_speech){$disabled_voice_fields = true;}
        ?>

        <div class="columnWrap" style="<?php echo empty($bctai_google_api_key) ? ' display:none':''?>">
            <div class="columnWrap column2">
                <div class="formTitle"><strong>Provider</strong></div>
                <div class="formContent">
                    <select <?php echo $disabled_voice_fields || (empty($bctai_google_api_key))  ? ' disabled': ''?> name="bctai_chat_widget[voice_service]" class="bctai_voice_service">
        ...
        <div class="bctai_voice_service_google" style="<?php echo $bctai_chat_voice_service == 'google' && (!empty($bctai_google_api_key) || !empty($bctai_elevenlabs_api)) ? '' : 'display:none'?>">
            ...
            <div class="columnWrap">
                <div class="columnWrap column2">
                    <div class="formTitle"><strong>Voice Language</strong></div>
                    <div class="formContent">
                        <select <?php echo empty($bctai_google_api_key) || $disabled_voice_fields ? ' disabled':''?>
                            name="bctai_chat_widget[voice_language]" class="bctai_voice_language">
            ...
            <div class="columnWrap">
                <div class="columnWrap column2">
                    <div class="formTitle"><strong>Voice Name</strong></div>
                    <div class="formContent">
                        <select <?php echo empty($bctai_google_api_key) || $disabled_voice_fields ? ' disabled':''?> data-value="<?php echo esc_html($bctai_voice_name)?>" name="bctai_chat_widget[voice_name]" class="bctai_voice_name"></select>
                    </div>
                </div>
            </div>
            ...
            <div class="columnWrap">
                <div class="columnWrap column2">
                    <div class="formTitle"><strong>Audio Device Profile</strong></div>
                    <div class="formContent">
                        <select <?php echo empty($bctai_google_api_key) || $disabled_voice_fields ? ' disabled':''?> name="bctai_chat_widget[voice_device]" class="bctai_voice_device">
            ...
            <div class="columnWrap">
                <div class="columnWrap column2">
                    <div class="formTitle"><strong>Voice Speed</strong></div>
                    <div class="formContent">
                        <input <?php echo empty($bctai_google_api_key) || $disabled_voice_fields ? ' disabled':''?> type="text" class="bctai_voice_speed" value="<?php echo esc_html($bctai_voice_speed)?>" name="bctai_chat_widget[voice_speed]">
                    </div>
                </div>
            </div>
            ...
            <div class="columnWrap">
                <div class="columnWrap column2">
                    <div class="formTitle"><strong>Voice Pitch</strong></div>
                    <div class="formContent">
                        <input <?php echo empty($bctai_google_api_key) || $disabled_voice_fields ? ' disabled':''?> type="text" class="bctai_voice_pitch" value="<?php echo esc_html($bctai_voice_pitch)?>" name="bctai_chat_widget[voice_pitch]">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mb-5">
            ...
            <input  <?php echo $bctai_save_logs ? '': ' disabled'?> class="regular-text bctai_chatbot_log_notice_message" value="<?php echo esc_html($bctai_log_notice_message)?>" type="text" name="bctai_chat_widget[log_notice_message]">
        </div> -->
    ...
    jQuery(document).ready(function($) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        alert("확인 되었습니다! 아래 index를 선택해주세요.");
        ...
        $('#bctai_chat_excerpt').on('click', function (){
            if($(this).prop('checked')){
                ...
                $('#bctai_vector_db_provider').attr('disabled','disabled');
                $('#bctai_qdrant_endpoint').attr('disabled','disabled');
                $('#wpaicg_qdrant_default_collection').attr('disabled','disabled');
        ...
        $('#bctai_chat_embedding').on('click', function() {
            if($(this).prop('checked')){
                ...
                $('#bctai_vector_db_provider').removeAttr('disabled','disabled');
                $('#bctai_qdrant_endpoint').removeAttr('disabled','disabled');
                $('#wpaicg_qdrant_default_collection').removeAttr('disabled','disabled');
            }
            else{
                $(this).prop('checked',true);
            }
