        ...
        <div class="chatbot">
            ...
            <div class="chatbotWriteWrap" style="position: absolute;bottom: 0px;left: 0;width: 100%;display: flex;">
                <div class="inputBtnArea">
                    <button class="btn onlyIcon iconFile"><span class="blind">파일첨부</span></button>
                </div>
                <textarea name="text" class="textAreaBox" id="textAreaBox"></textarea>
                
                <div class="inputBtnArea">
                    <button class="btn onlyIcon iconChatSpeak"><span class="blind">음성으로 메시지 입력</span></button>
                    <button class="btn onlyIcon iconChatTyping"><span class="blind">타이핑으로 메시지 입력</span></button>
                </div>
            </div>
        ...
        <div class="popup modalMenu">
            <div class="modalWrap modalFull">
                <div class="modalContainer">
                    ...
                    <button type="button" class="btn btnXL btnWhite iconFaq" onclick="javascript:openPop('modalFaq')"><span>1:1 문의</span></button>
                    <ul class="snsArea">
                    ...
                    <button class="btnSet" onclick="javascript:openPop('modalSetting')"><span class="blind">설정</span></button>
                </div>
            </div>
        </div>
            ...
            <div class="settingFormWrap">
              <div class="article">
                ...
                <div class="settingFormContent">
                  <input type="text" title="" class="center" placeholder="비씨티에이아이챗봇">
                </div>
              </div>
