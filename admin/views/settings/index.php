...
if (isset($_POST['bctai_submit'])) {
    ...
    if (isset($_POST['wpaicg_google_api_key']) && !empty($_POST['wpaicg_google_api_key'])) {
        update_option('wpaicg_google_model_api_key', sanitize_text_field($_POST['wpaicg_google_api_key']));
    }
    ...
    // }
    if (isset($_POST['Embedding_Provider']) && !empty($_POST['Embedding_Provider'])) {
        update_option('Embedding_Provider', sanitize_text_field($_POST['Embedding_Provider']));
    }
    if (isset($_POST['OpenAI_Embedding_model']) && !empty($_POST['OpenAI_Embedding_model'])) {
        update_option('OpenAI_Embedding_model', sanitize_text_field($_POST['OpenAI_Embedding_model']));
    }
    if (isset($_POST['Google_Embedding_model']) && !empty($_POST['Google_Embedding_model'])) {
        update_option('Google_Embedding_model', sanitize_text_field($_POST['Google_Embedding_model']));
    }
