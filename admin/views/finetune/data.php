...
<h1 style="font-weight: bolder;"><?php echo __('Data Converter', 'bctai') ?></h1>
<!-- <h1 class="wp-heading-inline"><?php echo esc_html__('Data Converter','bctai')?></h1> -->
...
<form id="bctai_data_converter" method="post" action="">
    ...
    <table class="form-table">
        <tbody>
        <tr>
            <th scope="row"><?php echo esc_html__('Select Data','bctai')?></th>
            <td>
                <label><input class="bctai_converter_data" checked type="checkbox" name="data[]" value="post"> <?php echo esc_html__('Posts','bctai')?></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <label><input class="bctai_converter_data" type="checkbox" name="data[]" value="page"> <?php echo esc_html__('Pages','bctai')?></label>
                <?php
                if(in_array('product',get_post_types()) && class_exists( 'woocommerce' )):
                ?>
                    <label><input class="bctai_converter_data" type="checkbox" name="data[]" value="product"> <?php echo esc_html__('Products','bctai')?></label>
                <?php
                endif;
                ?>
                <?php
                if( in_array('legalprotech',get_post_types()) ):
                ?>
                    <label><input class="bctai_converter_data" type="checkbox" name="data[]" value="legalprotech"> <?php echo esc_html__('Legalprotech','bctai')?></label>
                <?php
                endif;
                ?>
            </td>
        ...
        <tr>
            ...
            <td>
                ...
                <button class="button-primary button bctai_converter_button" style="background: #8040ad;border: #8040ad; border-radius: 13px;     width: 140px;"><?php echo esc_html__('Convert','bctai')?></button>
            </td>
        </tr>
        </tbody>
    </table>
...
<h1 style="font-weight: bolder;"><?php echo __('Completed Conversions', 'bctai') ?></h1>
<!-- <h1 class="wp-heading-inline"><?php echo esc_html__('Completed Conversions','bctai')?></h1> -->
<table class="wp-list-table widefat fixed striped table-view-list comments">
    ...
    <tr> 
        ...
        <td>
            <a class="button button-small" href="<?php echo wp_upload_dir()['baseurl'].'/'.esc_html($bctai_file->post_title)?>" download style="    width: 70px; border-radius: 10px; color: #ffffff;border-color: #8040ad;background: #8040ad;"><?php echo esc_html__('Download','bctai')?></a>
            <button class="button button-small bctai_convert_upload" data-lines="<?php echo esc_html(count(file($file)))?>" data-file="<?php echo esc_html($bctai_file->post_title)?>" style="    width: 70px; border-radius: 10px; color: #000000;border-color: #afadad;background: #c3c4c7;"><?php echo esc_html__('Upload','bctai')?></button>
        </td>
    </tr>
    <?php
        endif;
