...
<h2 class="sectionTitle">Trainings</h2>
...
<button href="javascript:void(0)" class="btn btnXS bgPrimary bctai_sync_finetunes"><?php echo esc_html__('Sync Fine-tunes', 'bctai') ?></button>
