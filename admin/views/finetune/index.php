...
if ($bctai_provider == 'Azure') {


} else {
    $bctai_action = isset($_GET['action']) && !empty($_GET['action']) && in_array(sanitize_text_field($_GET['action']), array('embeddings', 'fine-tunes', 'files', 'data', 'manual', 'upload')) ? sanitize_text_field($_GET['action']) : 'manual';
    ?>
        ...
        <div class="bctai_container">
            ...
            <div class="menu_wrap"style="overflow: hidden; width: 100%;">
                <ul class="BCT_nav">
                    ...
                    <li class="sub_menu" style="background:#352f39;"><a href="admin.php?page=Fine-tuning"><i class="fas fa-code fa-lg"style="color: #ffffff;"></i>   <?php echo __('Fine-tuning', 'bctai') ?> </a></li>
                    ...
                    <li class="sub_menu"><a href="admin.php?page=Modules"><i class="fas fa-solid fa-chart-simple fa-lg"style="color: #ffffff;"></i>  <?php echo __('Module', 'bctai') ?> </a></li>
                </ul>
                ...
                <ul class="sub_menu_ul" style="display:flex;">
                    <li class="nav_object"><a href="admin.php?page=Fine-tuning&action=manual" id="manual"><?php echo __('Data Entry','bctai')?></a></li>
                    <li class="nav_object"><a href="admin.php?page=Fine-tuning&action=upload" id="upload"><?php echo __('Upload','bctai')?></a></li>
                    <li class="nav_object"><a href="admin.php?page=Fine-tuning&action=data" id ="data"><?php echo __('Data Converter','bctai')?></a></li>
                    <li class="nav_object"><a href="admin.php?page=Fine-tuning&action=files" id ="files"><?php echo __('Datasets','bctai')?></a></li>
                    <li class="nav_object"><a href="admin.php?page=Fine-tuning&action=fine-tunes"id="fine-tunes"><?php echo __('Trainings','bctai')?></a></li>
                </ul>
                ...
                <ul class="sub_menu_ul">
                    ...
                    <li class="nav_object"><a href="admin.php?page=AI+ChatBot&action=QuestionList"><?php echo __('QuestionList','bctai')?></a></li>
                </ul>
            ...
            <div id="fs_account">
                ...
                <?php include(BCTAI_PLUGIN_DIR . 'admin/views/finetune/' . $bctai_action . '.php');
                echo "<style>#".$bctai_action." {font-size: 14px;font-weight: normal;color: #fff;}</style>";
                ?>
            </div>    
        </div>
    ...
    jQuery(document).ready(function ($) {
        ...
        $sub_menu.hover(function (x) {
            ...
            section.hover(function () {
                ...
                var idx = $(this).index();
                var section = $sub_menu_ul.eq(2);
                var hov_menu = $sub_menu.eq(2);
