...
<h2 class="sectionTitle">Speech to Text</h2>

<p><?php echo esc_html__('Simply press the record button and speak your prompt, just like you would in a conversation.', 'bctai') ?></p>
            ...
            <div class="column1">
                <div class="contentBox">
                    <div class="chapterContent">
                        <strong><?php echo esc_html__('Example', 'bctai') ?></strong>
                        <p>"<?php echo esc_html__("WordPress is an open-source, installable blog or content management system (CMS).", 'bctai') ?>"</p>
                        
                        <div class="btnArea">
                            <button type="button" class="btn btnL bgPrimary iconSpeak btn-start-record">
                                <span>speak</span>
                            </button>

                            <button type="button" class="btn btnL bgPrimary iconSpeak btn-pause-record" style="display: none;">
                                <span>Pause</span>
                            </button>

                            <button type="button" class="btn btnL bgPrimary iconStop btn-stop-record" style="display: none;">
                                <span>stop</span>
                            </button>

                            <button type="button" class="btn btnL bgPrimary iconCancel btn-abort-record" style="display: none;">
                                <span>cancel</span>
                            </button>
                        </div>

                        <p class="bctai-sending-record" style="display:none;">
                            <button class="btn-cancel-record"style="display: inline-flex;color: #0b9529;">
                                <span class="spinner"style="visibility: unset;margin-top: 0"></span>
                                <?php echo esc_html__('Generating Content..Please Wait..', 'bctai') ?>
                            </button><br>[<?php echo esc_html__('Click to cancel', 'bctai') ?>]
                        </p>
                        ...
                        <div class="bctai-speech-result" style="margin-top: 20px;display: none">
                            <div class="bctai-mb-10">
                                <input type="text" class="regular-text bctai-speech-title" style="width: 100%;font-size: 20px"placeholder="<?php echo esc_html__('Enter a Post Title', 'bctai') ?>">
                            </div>
                            <div class="mb-5">
                                <strong><?php echo esc_html__('Post Content', 'bctai') ?></strong>
                            </div>
                            <div class="bctai-mb-10">
                                <?php wp_editor('','bctai-speech-content',array('editor_height' => 425,'textarea_rows' => 20)); ?>
                            </div>
