...
<div class="wrap">
    ...
    <form id="tts-evaluation-form" method="post" enctype="multipart/form-data">
        <table class="form-table">
            ...
            <tr valign="top">
                <th scope="row">STT Audio File</th>
                <td>
            ...
            <tr valign="top">
                <th scope="row">STT 스피치</th>
                <td>
                    <button class="button button-primary button-hero btn-start-record">
                        <span><i class="fa-solid fa-microphone"></i> <?php echo esc_html__('Speak', 'bctai') ?></span>
                    </button>



                    <button class="button button-primary button-hero btn-pause-record" style="display: none;">
                        <span><i class="fa-solid fa-pause"></i> <?php echo esc_html__('Pause', 'bctai') ?></span>
                    </button>

                    <button class="button button-link-delete button-hero btn-stop-record" style="display: none;">
                        <span><i class="fa-solid fa-stop"></i> <?php echo esc_html__('Stop', 'bctai') ?></span>
                    </button>
                    
                    <button class="button button-link-delete button-hero btn-abort-record" style="display: none;">
        ...
        <?php submit_button('Evaluate TTS'); ?>
    </form>
</div>
