    ...
    <div class="bctai_container">
        ...
        <div class="menu_wrap" style="overflow: hidden; width: 100%;">
            <ul class="BCT_nav">
                ...
                <li class="sub_menu" style="background:#352f39;"><a href="admin.php?page=Audio"><i class="fa-solid fa-volume-high fa-lg"style="color: #ffffff;"></i>   <?php echo __('Audio', 'bctai') ?></a></li>
            ...
            <ul class="sub_menu_ul" style="display:flex;">
                <li class="nav_object"><a href="admin.php?page=Audio" id="tag_bold1"><?php echo __('Speech To Text','bctai')?></a></li>
                <li class="nav_object"><a href="admin.php?page=Audio&action=Web_Speech_API" id="tag_bold2"><?php echo __('Web Speech API','bctai')?></a></li>
                <?php
                $STTEvaluation_status = get_option('STT Evaluation');
                //echo $STTEvaluation_status;

                if($STTEvaluation_status){

                ?>
                <li class="nav_object"><a href="admin.php?page=Audio&action=bct-tts-evaluation" id="tag_bold3"><?php echo __('STT WER Test(Web API)','bctai')?></a></li>
                <li class="nav_object"><a href="admin.php?page=Audio&action=bct-STT-google" id="tag_bold4"><?php echo __('STT WER Test(google)','bctai')?></a></li>
            ...
            <div id="fs_account">
                ...
                if (empty($bctai_action)):
                    ...
                    include __DIR__ . '/speech2text.php';
                elseif ($bctai_action == 'Web_Speech_API'):
                    echo "<style>#tag_bold2 {font-size: 14px;font-weight: normal;color: #fff;}</style>";
                    include __DIR__ . '/Web_Speech_API.php';
                // elseif ($bctai_action == 'audioconverter'):
                //     echo "<style>#tag_bold3 {font-size: 14px;font-weight: normal;color: #fff;}</style>";
                //     include __DIR__ . '/converter.php';

                elseif ($bctai_action == 'bct-tts-evaluation'):
                    echo "<style>#tag_bold3 {font-size: 14px;font-weight: normal;color: #fff;}</style>";
                    include __DIR__ . '/bct-tts-evaluation.php';

                elseif ($bctai_action == 'bct-STT-google'):
                    echo "<style>#tag_bold4 {font-size: 14px;font-weight: normal;color: #fff;}</style>";
                    include __DIR__ . '/bct-STT-google.php';
                endif;
                ?>
            </div>
    </div>
    ...
    jQuery(document).ready(function ($) {
        ...
        $sub_menu.hover(function (x) {
            ...
            section.hover(function () {
                ...
                var idx = $(this).index();
                var section = $sub_menu_ul.eq(3);
                var hov_menu = $sub_menu.eq(3);
