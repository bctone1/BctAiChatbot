...
<div class="bctai_container">
    <div class="menu_wrap"style="overflow: hidden; width: 100%;">
            <ul class="BCT_nav">
                ...
                <li class="sub_menu" style="background:#352f39;"><a href="admin.php?page=Statistics"><i class="fas fa-solid fa-chart-simple fa-lg"style="color: #ffffff;"></i>  <?php echo __('Statistics', 'bctai') ?> </a></li>
            ...
            <ul class="sub_menu_ul" >
                ...
                <li class="nav_object"><a href="admin.php?page=Audio&action=Web_Speech_API"><?php echo __('Speech API','bctai')?> </a></li>
                <?php
            ...
            <ul class="sub_menu_ul" style="display:flex;">
                <li class="nav_object"><a href="admin.php?page=Statistics" id="tag_bold1"><?php echo __('Dashboard','bctai')?></a></li>
            </ul>
            <ul class="sub_menu_ul">
    ...
    jQuery(document).ready(function ($) {
        ...
        $sub_menu.hover(function (x) {
            ...
            section.hover(function () {
                ...
                var idx = $(this).index();
                var section = $sub_menu_ul.eq(5);
                var hov_menu = $sub_menu.eq(5);
