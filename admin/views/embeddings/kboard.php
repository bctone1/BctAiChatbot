...
<button onclick ="changeboard()">게시판 확인</button>

<a style="height: 32px; color: #8040ad; border: 1px solid #8040ad; background: #f6f7f7;" href="javascript:void(0)" class="button button-primary bctai_kboard_embedding"><?php echo esc_html__('Instant Embedding','bctai')?></a>
