...
<style>
    ...
    .bctai-nomu-Category1 {
        width: 100%;
    }

    .bctai-nomu-Category2 {
        width: 100%;
    }
...
<h1 style="font: normal normal 900 24px/35px Noto Sans KR; margin:0px;"><?php echo __('Contents Builder', 'bctai') ?></h1>
...
<form action="" method="post" id="bctai_embeddings_form">
    ...
    <div class="bctai-mb-10" style="display: flex;">
        <p style=""><strong><?php echo esc_html__('Content Type', 'bctai') ?></strong></p>
