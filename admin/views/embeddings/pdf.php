...
<style>
    ...
    .bctai_pdf_progress.bctai_error span{
        background: #d63638;
    }
    .bctai_modal{
        top: 5%;
...
<div class="bctai_pdf">
    <p>
        <strong><?php echo esc_html__('Select PDF File','bctai')?>: </strong>
        <input type="file" class="bctai_pdf_file" accept="application/pdf">
        <button class="button button-primary bctai_pdf_start"><?php echo esc_html__('Embeddings','bctai')?></button>
    </p>
