...
<div class="bctai_container">
    <div class="menu_wrap"style="overflow: hidden; width: 100%;">
            <ul class="BCT_nav">
                ...
                <li class="sub_menu" style="background:#352f39;"><a href="admin.php?page=Modules"><i class="fas fa-solid fa-chart-simple fa-lg"style="color: #ffffff;"></i>  <?php echo __('Module', 'bctai') ?> </a></li>
            </ul>
            ...
            <ul class="sub_menu_ul" style="display:flex;">
                <li class="nav_object"><a href="admin.php?page=Modules" id="tag_bold1"><?php echo __('Module','bctai')?></a></li>
            </ul>
        </div>
            <div id="fs_account">
                <?php
                if (empty($bctai_action)):
                    ...
                    include __DIR__ . '/module_manager.php';
    ...
    jQuery(document).ready(function ($) {
        ...
        $sub_menu.hover(function (x) {
            ...
            section.hover(function () {
                ...
                var idx = $(this).index();
                var section = $sub_menu_ul.eq(6);
                var hov_menu = $sub_menu.eq(6);
