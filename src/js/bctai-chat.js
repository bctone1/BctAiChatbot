    ...
    var bctaiChatTyping = document.querySelectorAll('.bctai-chat-widget-typing');
    var bctaiChatSend = document.querySelectorAll('.btn-send_widget');
    ...
    let data_stt_value;
    let bctaiSTTinput = document.getElementById('bctai-chat-widget-typing');
        ...
        if(Scenario_status){
            document.addEventListener('DOMContentLoaded', function () {
                bctaiSTTinput.addEventListener('input', function () {
                    ...
                    if(this.scrollHeight <60){
                        bctaichat_content.style.padding = '0px 0px 207px 10px';
            ...
            document.addEventListener('DOMContentLoaded', function () {
                bctaiSTTinput.addEventListener('input', function () {
                    ...
                    this.style.height = (this.scrollHeight > 160 ? 160 : this.scrollHeight) + 'px';
                    if(this.scrollHeight <60){
                        bctaichat_content.style.padding = '0px 0px 107px 10px';
                        bctaichat_message.scrollTop = bctaichat_message.scrollHeight;
                    }else if(this.scrollHeight <80){
                ...
                if (xhttp.status === 200) {
                    ...
                    if (bctai_response !== '') {
                        ...
                        if (bctai_response.status === 'success') {
                            ...
                            console.log(bctai_response_url);
                            ...
                            bctai_message += bctai_response_text;
    ...
    function bctaiWriteMessage(bctai_messages_box, bctai_message, bctai_randomnum, bctai_response_text, cosine_score) {
        ...
        for (let i = 0; i < bctaiChatTyping.length; i++) {
            bctaiChatTyping[i].addEventListener('keyup', function (event) {
                if (event.shiftKey && (event.which === 13 || event.keyCode === 13)) {
                    ...
                    let chatTyping = parentChat.querySelectorAll('.bctai-chat-widget-typing')[0];
    ...
    jQuery('.btn-fullscreen').click(function () {
        ...
        if (isExpanded) {
            ...
            jQuery('.bctai_chat_widget_content').css({
                'height': '690px', 
                'width': '1335px'   
            });
            jQuery('.high').css({
