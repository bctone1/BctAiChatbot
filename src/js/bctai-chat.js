...
function bctaiSendChatMessage(chat, typing, type, blob) {
    ...
    let bctai_question;
    let Scenario_status = chatbox.getAttribute('data-Scenario_status');
    ...
    bctaiMessage += "<div style='width: 100%; float: right; margin-top:10px;'><div class='message right'><span class='name'><i class='cbiCon'></i></span><div class='bubble'><div class='txt'>";
        ...
        if (file) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    var imgTag= "<div style='width: 100%; float: right; margin-top:10px;'><div class='message right'><div class='bubble'><img style='width:100%;' src='" + response.file_url + "'></div><div class='date'>" + date_Time + "</div></div></div>";
