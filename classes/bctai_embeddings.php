    ...
    class BCTAI_Embeddings
    {
        ...
        public function generate_table_row($post) {
            ...
            return "<tr id='post-row-{$post->id}'>
                        ...
                        <td class='column-source'>
                            <a href='" . esc_url(admin_url('post-new.php?post_title=' . urlencode($post->data))) . "' class='button'>Add Post</a>
                        </td>
                    </tr>";
        }
        ...
        {            
            ...
            if($bctai_data)
                ...
                $bctai_result = $this->bctai_save_embedding($bctai_title, 'bctai_builder', $bctai_data->post_title, $bctai_old_builder,$value);
                // return $bctai_result;
        ...
        public function bctai_save_embedding($content, $post_type = '', $title = '', $embeddings_id = false,$value)
        {
            //return $content;
                        ...
                        if(empty($embedding)) {
                            ...
                            if(is_wp_error($embeddings_id)){
                                ...
                                if($bctai_vector_db_provider === 'qdrant'){
                                    ...
                                    $qdrant_url = $bctai_qdrant_endpoint . '/' . $default_qdrant_collection . '/points';
